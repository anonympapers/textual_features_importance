...
colors = ["#348abd", "#348abd","#348abd","#348abd","#988ed5",  'pink',  "#e24a33", "#348abd", "#988ed5", "#777777", 'red', 'pink', 'yellow',  "#e24a33", "#348abd", "#988ed5", "#777777",] # whatever the colors may be but it should be different for each histogram.
